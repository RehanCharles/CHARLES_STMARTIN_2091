...
public class StudentGroup implements StudentArrayOperation {
	...
	public void addFirst1(Student string) {
	...
	public void addLast1(Student string) {
	...
	public void remove(String string) {
		 ...
		 int c = 0;
		 for(int i = 0; i < this.students.length; i++)
			 if(i != string) temp[c++] = this.students[i];
		 this.students = temp;
	}
	...
	@Override
	public Student getNextStudent(String student) {
           this.bubbleSort();
		   int i;
	...
	@Override
	public void add(Student string, int index) {
         Student[] temp = new Student[this.students.length+1];
		 for(int i = 0; i < index; i++)
			 temp[i] = this.students[i];
		 temp[index] = string;
